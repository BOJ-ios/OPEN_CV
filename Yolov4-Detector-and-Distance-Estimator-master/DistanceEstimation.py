...
yoloNet = cv.dnn.readNet('yolo\yolov4-tiny.weights', 'yolo\yolov4-tiny.cfg')
...
ref_person = cv.imread(
    'Yolov4-Detector-and-Distance-Estimator-master\ReferenceImages\image14.png')
ref_mobile = cv.imread(
    'Yolov4-Detector-and-Distance-Estimator-master\ReferenceImages\image4.png')
